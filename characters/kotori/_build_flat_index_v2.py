"""Flat FAISS index for kotori v2 — SELECTED slices' features only.
...
training arms (features are identical across arms).
    ...
    python _build_flat_index_v2.py --exp kotori_v2
"""
...
OUT = Path(__file__).resolve().parents[2] / "characters/kotori/models_v2/flat_full_src_feat.index"
