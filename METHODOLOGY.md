...
## 13. 逐句混音参数表 (本曲, 供 review)

> 55 个乐句, 每句列出**演唱音色 + 施加的各维度处理值**。用于向他人展示/收集反馈。
> 完整机器可读版: `tools/line_table.csv`。
...
| 静态增益 | 整轨均值 → 目标的固定增益 (女 +8~9 / 男 +17~18dB, 男声源本就轻 ~9dB) |
| 逐句增益 | 在静态之上, 该句为达到统一目标的额外增减 (§12.3-1) |
| **净增益** | 静态 + 逐句 = 该句实际被抬升的总量 |
| 同唱人数 | 该句时间窗内的平均并发音色数 (1=独唱, 3=男声齐唱, 6=全员) |
| 声像 | C=正中 / L·R+数值 = 左右偏移百分比 (仅合唱段展开, §12.3-5) |
| 齐唱缩放 | 1/√N 定律施加的衰减 (§12.3-3) |
| 合唱去相关 | 男声人性化微时移是否生效 (§12.3-4) |

**结构一览**: 0:06–1:06 男女交替对唱 · 1:06–2:30 长段独唱 · 2:30–2:55 男女重叠 ·
...
| 2 | 0:07.9–0:11.2 | 3.3s | cecil-ai | -21.1 | +17.0 | +9.2 | **+26.2** | 1.5 | C | -1.7 | — |
| 3 | 0:09.1–0:10.8 | 1.7s | kotori | -12.4 | +7.9 | +0.4 | **+8.4** | 1.9 | C | -2.8 | — |
| 4 | 0:11.9–0:13.6 | 1.7s | cecil-ai | -18.6 | +17.0 | +6.7 | **+23.7** | 0.9 | C | +0.0 | — |
| 5 | 0:13.9–0:16.7 | 2.8s | kotori | -12.7 | +7.9 | +0.8 | **+8.7** | 1.5 | C | -1.8 | — |
| 6 | 0:15.0–0:17.3 | 2.3s | cecil-ai | -18.5 | +17.0 | +6.6 | **+23.6** | 1.7 | C | -2.2 | — |
| 7 | 0:30.3–0:35.3 | 5.0s | honoka | -15.0 | +9.0 | +3.0 | **+12.0** | 0.9 | C | +0.0 | — |
| 8 | 0:35.7–0:41.6 | 5.9s | otoya-tsukasa | -23.8 | +17.3 | +10.0 | **+27.3** | 1.0 | C | +0.0 | — |
| 9 | 0:41.7–0:47.3 | 5.6s | honoka | -15.3 | +9.0 | +3.3 | **+12.3** | 0.9 | C | +0.0 | — |
| 10 | 0:47.7–0:53.7 | 6.0s | otoya-tsukasa | -20.2 | +17.3 | +8.3 | **+25.6** | 0.9 | C | +0.0 | — |
| 11 | 0:54.1–0:55.5 | 1.5s | umi | -16.3 | +8.0 | +4.3 | **+12.3** | 0.9 | C | +0.0 | — |
| 12 | 0:55.9–0:57.0 | 1.1s | camus-toya20 | -16.1 | +17.7 | +4.1 | **+21.9** | 0.9 | C | +0.0 | — |
| 13 | 0:57.4–1:00.3 | 2.9s | umi | -16.7 | +8.0 | +4.7 | **+12.7** | 0.9 | C | +0.0 | — |
| 14 | 1:00.4–1:01.5 | 1.1s | camus-toya20 | -18.9 | +17.7 | +7.0 | **+24.8** | 0.9 | C | +0.0 | — |
| 15 | 1:01.9–1:06.1 | 4.2s | umi | -13.2 | +8.0 | +1.3 | **+9.3** | 1.6 | R13 | -2.1 | — |
| 16 | 1:03.0–1:06.0 | 3.0s | camus-toya20 | -13.8 | +17.7 | +1.8 | **+19.6** | 1.9 | R18 | -2.8 | — |
| 17 | 1:06.8–1:18.2 | 11.4s | cecil-ai | -14.1 | +17.0 | +2.2 | **+19.2** | 0.9 | C | +0.0 | — |
...
| 26 | 2:30.8–2:32.0 | 1.2s | camus-toya20 | -18.1 | +17.7 | +6.2 | **+23.9** | 1.0 | C | +0.0 | — |
| 27 | 2:31.9–2:34.6 | 2.8s | umi | -19.0 | +8.0 | +7.1 | **+15.1** | 1.6 | R11 | -2.0 | — |
| 28 | 2:33.0–2:35.2 | 2.2s | camus-toya20 | -18.6 | +17.7 | +6.7 | **+24.4** | 1.7 | R13 | -2.2 | — |
| 29 | 2:36.8–2:37.9 | 1.1s | camus-toya20 | -14.3 | +17.7 | +2.4 | **+20.1** | 0.9 | C | +0.0 | — |
| 30 | 2:38.0–2:40.8 | 2.9s | umi | -16.9 | +8.0 | +5.0 | **+13.0** | 1.6 | R12 | -2.0 | — |
| 31 | 2:39.0–2:41.2 | 2.2s | camus-toya20 | -21.9 | +17.7 | +10.0 | **+27.7** | 1.8 | R15 | -2.5 | — |
| 32 | 2:42.8–2:45.4 | 2.6s | kotori | -15.4 | +7.9 | +3.4 | **+11.4** | 1.9 | C | -2.8 | — |
| 33 | 2:42.8–2:45.5 | 2.7s | cecil-ai | -14.1 | +17.0 | +2.1 | **+19.1** | 1.9 | C | -2.7 | — |
| 34 | 2:45.7–2:48.1 | 2.5s | honoka | -18.0 | +9.0 | +6.1 | **+15.1** | 1.9 | L18 | -2.7 | — |
| 35 | 2:45.8–2:48.4 | 2.5s | otoya-tsukasa | -14.8 | +17.3 | +2.9 | **+20.2** | 1.9 | L17 | -2.7 | — |
| 36 | 2:48.8–2:54.7 | 5.9s | camus-toya20 | -19.2 | +17.7 | +7.3 | **+25.1** | 1.7 | R15 | -2.4 | — |
| 37 | 2:48.8–2:55.0 | 6.2s | umi | -13.2 | +8.0 | +1.3 | **+9.3** | 1.7 | R15 | -2.3 | — |
| 38 | 3:08.2–3:13.6 | 5.4s | otoya-tsukasa | -13.0 | +17.3 | +1.1 | **+18.4** | 2.7 | L22 | -4.4 | 是 |
| 39 | 3:08.2–3:13.6 | 5.4s | cecil-ai | -13.3 | +17.0 | +1.4 | **+18.4** | 2.7 | C | -4.4 | 是 |
| 40 | 3:08.2–3:13.6 | 5.4s | camus-toya20 | -12.6 | +17.7 | +0.7 | **+18.4** | 2.7 | R22 | -4.4 | 是 |
| 41 | 3:14.2–3:19.6 | 5.5s | cecil-ai | -11.7 | +17.0 | -0.3 | **+16.7** | 2.9 | C | -4.6 | 是 |
| 42 | 3:14.2–3:19.6 | 5.5s | otoya-tsukasa | -11.3 | +17.3 | -0.6 | **+16.7** | 2.9 | L22 | -4.6 | 是 |
| 43 | 3:14.2–3:19.6 | 5.4s | camus-toya20 | -10.9 | +17.7 | -1.0 | **+16.7** | 2.9 | R22 | -4.6 | 是 |
| 44 | 3:20.3–3:25.6 | 5.4s | honoka | -11.8 | +9.0 | -0.2 | **+8.8** | 5.5 | L22 | -7.4 | 是 |
| 45 | 3:20.3–3:25.6 | 5.4s | umi | -11.8 | +8.0 | -0.1 | **+7.9** | 5.5 | R22 | -7.4 | 是 |
| 46 | 3:20.3–3:25.7 | 5.4s | otoya-tsukasa | -12.1 | +17.3 | +0.1 | **+17.4** | 5.5 | L22 | -7.4 | 是 |
| 47 | 3:20.3–3:25.7 | 5.4s | cecil-ai | -12.4 | +17.0 | +0.5 | **+17.5** | 5.5 | C | -7.4 | 是 |
| 48 | 3:20.3–3:25.7 | 5.4s | kotori | -13.9 | +7.9 | +1.9 | **+9.9** | 5.5 | C | -7.4 | 是 |
| 49 | 3:20.3–3:25.7 | 5.4s | camus-toya20 | -11.6 | +17.7 | -0.3 | **+17.4** | 5.5 | R22 | -7.4 | 是 |
| 50 | 3:26.2–3:34.5 | 8.3s | otoya-tsukasa | -12.0 | +17.3 | +0.1 | **+17.4** | 5.5 | L22 | -7.4 | 是 |
| 51 | 3:26.2–3:34.5 | 8.3s | cecil-ai | -12.2 | +17.0 | +0.3 | **+17.3** | 5.5 | C | -7.4 | 是 |
| 52 | 3:26.2–3:34.5 | 8.3s | camus-toya20 | -11.5 | +17.7 | -0.4 | **+17.3** | 5.5 | R22 | -7.4 | 是 |
